...
class Operations {
  constructor(core) {
    ...
    // 0x80
    cbMap[0x80] = this.RESr_B(0);
    cbMap[0x81] = this.RESr_C(0);
    cbMap[0x82] = this.RESr_D(0);
    cbMap[0x83] = this.RESr_E(0);
    cbMap[0x84] = this.RESr_H(0);
    cbMap[0x85] = this.RESr_L(0);
    cbMap[0x86] = this.RESHL(0);
    cbMap[0x87] = this.RESr_A(0);
    cbMap[0x88] = this.RESr_B(1);
    cbMap[0x89] = this.RESr_C(1);
    cbMap[0x8a] = this.RESr_D(1);
    cbMap[0x8b] = this.RESr_E(1);
    cbMap[0x8c] = this.RESr_H(1);
    cbMap[0x8d] = this.RESr_L(1);
    cbMap[0x8e] = this.RESHL(1);
    cbMap[0x8f] = this.RESr_A(1);

    // 0x90
    cbMap[0x90] = this.RESr_B(2);
    cbMap[0x91] = this.RESr_C(2);
    cbMap[0x92] = this.RESr_D(2);
    cbMap[0x93] = this.RESr_E(2);
    cbMap[0x94] = this.RESr_H(2);
    cbMap[0x95] = this.RESr_L(2);
    cbMap[0x96] = this.RESHL(2);
    cbMap[0x97] = this.RESr_A(2);
    cbMap[0x98] = this.RESr_B(3);
    cbMap[0x99] = this.RESr_C(3);
    cbMap[0x9a] = this.RESr_D(3);
    cbMap[0x9b] = this.RESr_E(3);
    cbMap[0x9c] = this.RESr_H(3);
    ...
    // 0xB0
    cbMap[0xb0] = this.RESr_B(6);
    cbMap[0xb1] = this.RESr_C(6);
    cbMap[0xb2] = this.RESr_D(6);
    cbMap[0xb3] = this.RESr_E(6);
    cbMap[0xb4] = this.RESr_H(6);
    cbMap[0xb5] = this.RESr_L(6);
    cbMap[0xb6] = this.RESHL(6);
    cbMap[0xb7] = this.RESr_A(6);
    cbMap[0xb8] = this.RESr_B(7);
    cbMap[0xb9] = this.RESr_C(7);
    cbMap[0xba] = this.RESr_D(7);
    cbMap[0xbb] = this.RESr_E(7);
    cbMap[0xbc] = this.RESr_H(7);
    cbMap[0xbd] = this.RESr_L(7);
    cbMap[0xbe] = this.RESHL(7);
    cbMap[0xbf] = this.RESr_A(7);

    // 0xC0
    cbMap[0xc0] = this.SETr_B(0);
    cbMap[0xc1] = this.SETr_C(0);
    cbMap[0xc2] = this.SETr_D(0);
    cbMap[0xc3] = this.SETr_E(0);
    cbMap[0xc4] = this.SETr_H(0);
    cbMap[0xc5] = this.SETr_L(0);
    cbMap[0xc6] = this.SETHL(0);
    cbMap[0xc7] = this.SETr_A(0);
    cbMap[0xc8] = this.SETr_B(1);
    cbMap[0xc9] = this.SETr_C(1);
    cbMap[0xca] = this.SETr_D(1);
    cbMap[0xcb] = this.SETr_E(1);
    cbMap[0xcc] = this.SETr_H(1);
    cbMap[0xcd] = this.SETr_L(1);
    cbMap[0xce] = this.SETHL(1);
    cbMap[0xcf] = this.SETr_A(1);

    // 0xD0
    cbMap[0xd0] = this.SETr_B(2);
    cbMap[0xd1] = this.SETr_C(2);
    cbMap[0xd2] = this.SETr_D(2);
    cbMap[0xd3] = this.SETr_E(2);
    cbMap[0xd4] = this.SETr_H(2);
    cbMap[0xd5] = this.SETr_L(2);
    cbMap[0xd6] = this.SETHL(2);
    cbMap[0xd7] = this.SETr_A(2);
    cbMap[0xd8] = this.SETr_B(3);
    cbMap[0xd9] = this.SETr_C(3);
    cbMap[0xda] = this.SETr_D(3);
    cbMap[0xdb] = this.SETr_E(3);
    cbMap[0xdc] = this.SETr_H(3);
    ...
    // 0xF0
    cbMap[0xf0] = this.SETr_B(6);
    cbMap[0xf1] = this.SETr_C(6);
    cbMap[0xf2] = this.SETr_D(6);
    cbMap[0xf3] = this.SETr_E(6);
    cbMap[0xf4] = this.SETr_H(6);
    cbMap[0xf5] = this.SETr_L(6);
    cbMap[0xf6] = this.SETHL(6);
    cbMap[0xf7] = this.SETr_A(6);
    cbMap[0xf8] = this.SETr_B(7);
    cbMap[0xf9] = this.SETr_C(7);
    cbMap[0xfa] = this.SETr_D(7);
    cbMap[0xfb] = this.SETr_E(7);
    cbMap[0xfc] = this.SETr_H(7);
